...
var q = {
    ...
    4: {"subject": "4. 여성가족부", "title": "여성가족부 폐지 여부에 대해서<br>선택지를 고르세요.", "type": "mog ", "A": ["여성가족부를 폐지해야 한다.", [5, 3, 1, 1]], "B": ["대대적인 개편이 필요하다고 본다.", [2, 2, 0, 0]], "C": ["잘 모르겠다", [0, 0, 0, 0]], "D": ["여성 가족부는 유지되어야 한다.", [0, 0, 2, 2]], "E": ["여성가족부를 강화해야 한다.", [0, 0, 5, 3]], "length": 5},
    ...
    10: {"subject": "10. 지지율", "title": "후보별 지지율이 당신의 투표에 미치는 영향에 대해<br>선택지를 고르세요.", "type": "approval-rating", "A": ["지지율에 상관없이<br>내가 원하는 후보자에 투표할 것이다.", [0, -15, -15, 0]], "B": ["지지율이 낮은 후보들은 당선되기가<br>어렵기 때문에 투표할 생각이 별로 없다.", [0, 0, 0, 0]], "length": 2},
}
var result = {
