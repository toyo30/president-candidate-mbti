...
var q = {
    1: {"subject": "1. 부동산", "title": "다음은 부동산 정책입니다.<br>선택지를 고르세요.", "type": "estate", "A": ["정부가 적극적으로 개입하여<br>많은 정책 조정으로 가격 안정화에<br>힘을 쏟아야 한다.", [0, 1, 2, 4]], "B": ["시장의 역할을 살리기 위해<br> 대출 규제를 완화하고 복지에 힘써야 한다.", [3, 2, 0, 0]], "C": ["잘 모르겠다.", [0, 0, 0, 0]], "length": 3},
    2: {"subject": "2. 대북", "title": "다음은 대북 정책입니다.<br>선택지를 고르세요.", "type": "north", "A": ["강경 대응하고 긴급상황시<br> 선제공격도 감수한다.", [4, 2, -4, 0]], "B": ["잦은 협상으로 관계를 평화적으로 이끈다.", [0, 0, 4, 4]], "C": ["잘 모르겠다.", [0, 0, 0, 0]], "length": 3},
    ...
    4: {"subject": "4. 여성가족부", "title": "여성가족부 폐지 여부에 대해서<br>선택지를 고르세요.", "type": "mog ", "A": ["여성가족부를 폐지해야 한다.", [5, 2, -4, 0]], "B": ["대대적인 개편이 필요하다고 본다.", [2, 2, 0, 0]], "C": ["잘 모르겠다.", [0, 0, 0, 0]], "D": ["여성가족부는 개편할 부분이 있다.", [0, 0, 2, 2]], "E": ["여성가족부를 강화해야 한다.", [0, 0, 5, 3]], "length": 5},
    ...
    6: {"subject": "6. 방역 대책", "title": "일상을 되찾을 때까지 모두 힘내세요!<br>방역 대책에 대해 어떻게 생각하시나요?", "type": "covid", "A": ["방역패스를 철회하고<br> 새로운 방안을 찾아야 한다.", [5, 2, 2, 0]], "B": ["현재의 방역 방침을<br>개편하여 이어가야 한다.", [0, 0, 0, 5]], "C": ["잘 모르겠다.", [0, 0, 0, 0]], "length": 3},
    ...
    8: {"subject": "8. 정권 교체", "title": "정권 교체의 필요성에 대해<br> 선택지를 고르세요.", "type": "regime", "A": ["정권 교체에 초점을 맞추지는 않는다.", [0, 0, 0, 3]], "B": ["현 정부는 정권교체가 절실히 필요하다.", [0, 0, 0, -15]], "length": 2},
    9: {"subject": "9. 후보의 역량", "title": "후보 개인 역량의 중요성에 대해<br> 선택지를 고르세요.", "type": "cap", "A": ["대통령은 최종 결정권자이기 때문에<br> 개인의 역량은 매우 중요하다.", [-15, 0, 0, 0]], "B": ["후보의 역량이 부족해도<br> 각 분야의 인재들을 적재적소에 기용하면<br> 훌륭한 지도자가 될 수 있다.", [2, 0, 0, 0]], "length": 2},
    10: {"subject": "10. 지지율", "title": "지지율이 낮은 후보에 투표하는 것에 대해<br>어떻게 생각하시나요?", "type": "approval-rating", "A": ["지지율에 상관없이<br>내가 원하는 후보자에 투표할 것이다.", [0, 0, 0, 0]], "B": ["지지율이 높은 후보에<br> 전략적으로 투표할 생각이다.", [0, -15, -15, 0]], "length": 2},
}
...
$(document).on('click', '.add-insta', function() {
    var url = '';
	var textarea = document.createElement("textarea");
	document.body.appendChild(textarea);
	url = window.document.location.href;
    ...
    // onclick="window.open('https://www.instagram.com/')" target='_blank'
