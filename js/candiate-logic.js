...
var q = {
    1: {"subject": "1. 부동산", "title": "다음은 부동산 정책입니다.<br>선택지를 고르세요.", "type": "estate", "A": ["정부가 적극적으로 개입하여<br>많은 정책 조정으로 가격 안정화에<br>힘을 쏟아야 한다.", [0, 3, 5, 5]], "B": ["시장의 역할을 살리기 위해<br> 대출 규제를 완화하고 복지에 힘써야 한다.", [5, 3, 0, 0]], "C": ["중간이거나 잘 모르겠다.", [0, 0, 0, 0]], "length": 3},
    2: {"subject": "2. 대북", "title": "다음은 대북 정책입니다.<br>선택지를 고르세요.", "type": "north", "A": ["강경 대응하고 긴급상황시<br> 선제공격도 감수한다.", [3, 1, -3, -3]], "B": ["잦은 협상으로 관계를 평화적으로 이끈다.", [-3, -1, 3, 3]], "C": ["중간이거나 잘 모르겠다.", [0, 0, 0, 0]], "length": 3},
    3: {"subject": "3. 경제", "title": "경제 성장 공약입니다.<br>선택지를 고르세요.", "type": "financial", "A": ["민간과 기업에 대한 복지 유치로<br>경제 생태계를 복원하고<br>개개인의 삶의 질 상승에 초점을 맞춘다.", [5, 0, 0, 0]], "B": ["디지털, 에너지 신산업 중심으로 한<br>사회서비스 대전환으로<br> 수많은 일자리를 창출한다.", [0, 0, 0, 5]], "C": ["2차전지, 수소산업, 시스템반도체, 콘텐츠,<br>바이오 등 향후 큰 성장이 기대되는<br>5대 사업에 집중 성장을 유도한다.", [0, 5, 0, 0]], "D": ["주 4일 근무제를 도입하고<br> 지역균형, 국토균형 발전과 함께<br>재생 에너지 산업에 주력한다.", [0, 0, 5, 0]], "E": ["중간이거나 잘 모르겠다.", [0, 0, 0, 0]], "length": 5},
    4: {"subject": "4. 여성가족부", "title": "여성가족부 폐지 여부에 대해서<br>선택지를 고르세요.", "type": "mog ", "A": ["여성가족부를 폐지해야 한다.", [3, 1, -3, -1]], "B": ["대대적인 개편이 필요하다고 본다.", [1, 0, -1, 0]], "C": ["중간이거나 잘 모르겠다", [0, 0, 0, 0]], "D": ["여성 가족부는 유지되어야 한다.", [-1, 0, 1, 0]], "E": ["여성가족부를 강화해야 한다.", [-3, -1, 3, 1]], "length": 5},
    5: {"subject": "5. 논란", "title": "후보 관련 논란에 대해<br>어떻게 생각하시나요?", "type": "moral", "A": ["후보의 지지를 철회할 정도는 아니다.", [0, 0, 0, 0]], "B": ["지도자로서 관련 논란은 매우 중요하다.", [-1, 0, 0, -3]], "length": 2},
    6: {"subject": "6. 방역 대책", "title": "일상을 되찾을 때까지 모두 힘내세요!<br>방역 대책에 대해 어떻게 생각하시나요?", "type": "covid", "A": ["방역패스를 철회하고<br> 새로운 방안을 찾아야 한다.", [5, 3, 5, 0]], "B": ["현재의 방역 방침을<br>개편하여 이어가야 한다.", [0, 0, 0, 5]], "C": ["중간이거나 잘 모르겠다.", [0, 0, 0, 0]], "length": 3},
    7: {"subject": "7. 정치 개혁", "title": "정치 개혁 관련 공약입니다.<br>선택지를 고르세요.", "type": "prosecution", "A": ["정파와 연령에 관계없이 인재를<br> 등용하여 완전히 새로운 내각으로<br> 통합된 정부를 만든다.", [0, 3, 3, 0]], "B": ["분야별로 정예화된 위원회와<br> 참모진을 구성하여 전문성을 높이고<br> 권력의 집중도를 낮춘다.", [3, 0, 0, 0]], "C": ["대통령의 권한을 대폭 축소시키고<br> 정파를 가리지 않는 ‘연합정치’ 를 시행한다.", [0, 0, 0, 3]], "D": ["청와대의 각 수석 제도를<br> 즉각 폐지하고 의회 중심제로 전환한다.", [0, 0, 0, 0]], "E": ["중간이거나 잘 모르겠다.", [0, 0, 0, 0]], "length": 5},
    ...
    9: {"subject": "9. 후보의 역량", "title": "후보 개인 역량의 중요성에 대해<br> 선택지를 고르세요.", "type": "cap", "A": ["대통령은 최종 결정권자이기 때문에<br> 개인의 역량은 매우 중요하다.", [-2, 1, 0, 2]], "B": ["후보의 역량이 부족해도<br> 각 분야의 인재들을 적재적소에 기용하면<br> 훌륭한 지도자가 될 수 있다.", [0, 0, 0, 0]], "length": 2},
    10: {"subject": "10. 지지율", "title": "후보별 지지율이 당신의 투표에 미치는 영향에 대해<br>선택지를 고르세요.", "type": "approval-rating", "A": ["지지율에 상관없이<br>내가 원하는 후보자에 투표할 것이다.", [-2, 1, 0, 2]], "B": ["지지율이 낮은 후보들은 당선되기가<br>어렵기 때문에 투표할 생각이 별로 없다.", [0, 0, 0, 0]], "length": 2},
}
var result = {
